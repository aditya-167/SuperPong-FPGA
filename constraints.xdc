...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN V9 [get_ports cam_pwdn]
set_property IOSTANDARD LVCMOS33 [get_ports cam_pwdn]
##Sch name = JB2
set_property PACKAGE_PIN V8 [get_ports {cam_db[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cam_db[0]}]
##Sch name = JB3
set_property PACKAGE_PIN V7 [get_ports {cam_db[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cam_db[2]}]
##Sch name = JB4
set_property PACKAGE_PIN W7 [get_ports {cam_db[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cam_db[4]}]
##Sch name = JB7
set_property PACKAGE_PIN W9 [get_ports cam_rstn]
set_property IOSTANDARD LVCMOS33 [get_ports cam_rstn]
##Sch name = JB8
set_property PACKAGE_PIN Y9 [get_ports {cam_db[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cam_db[1]}]
##Sch name = JB9
set_property PACKAGE_PIN Y8 [get_ports {cam_db[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cam_db[3]}]
##Sch name = JB10
set_property PACKAGE_PIN Y7 [get_ports {cam_db[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cam_db[5]}]

##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN Y6 [get_ports {cam_db[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cam_db[6]}]
##Sch name = JC2
set_property PACKAGE_PIN AA6 [get_ports cam_xclk]
set_property IOSTANDARD LVCMOS33 [get_ports cam_xclk]
##Sch name = JC3
set_property PACKAGE_PIN AA8 [get_ports  cam_href]
...
##Sch name = JC7
set_property PACKAGE_PIN R6 [get_ports {cam_db[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cam_db[7]}]
##Sch name = JC8
set_property PACKAGE_PIN T6 [get_ports cam_pclk]
set_property IOSTANDARD LVCMOS33 [get_ports cam_pclk]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets cam_pclk]
##Sch name = JC9
set_property PACKAGE_PIN AB7 [get_ports cam_vsync]
set_property IOSTANDARD LVCMOS33 [get_ports cam_vsync]
##Sch name = JC10
set_property PACKAGE_PIN AB6 [get_ports cam_scl]
