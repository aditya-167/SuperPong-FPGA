...
HD_PWD='C:/Users/Public/Vivado_Projects/Nexys-Video-HDMI/proj/HDMI.runs/hdmi_PmodJSTK2_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_PmodJSTK2_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_PmodJSTK2_1_0.tcl
