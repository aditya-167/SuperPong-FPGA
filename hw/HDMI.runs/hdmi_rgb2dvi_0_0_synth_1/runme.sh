...
HD_PWD='C:/Users/Public/Vivado_Projects/Nexys-Video-HDMI/proj/HDMI.runs/hdmi_rgb2dvi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_rgb2dvi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_rgb2dvi_0_0.tcl
