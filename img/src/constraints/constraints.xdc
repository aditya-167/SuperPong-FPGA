...
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports LED_driver[0]]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports LED_driver[1]]
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports LED_driver[2]]
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports LED_driver[3]]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports LED_driver[4]]
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports LED_driver[5]]
set_property -dict {PACKAGE_PIN Y13 IOSTANDARD LVCMOS33} [get_ports LED_driver[6]]
...
##Sch name = JB2
set_property PACKAGE_PIN V8 [get_ports {OV7670_D[1]}] 
set_property IOSTANDARD LVCMOS33 [get_ports {OV7670_D[1]}]
##Sch name = JB3
set_property PACKAGE_PIN V7 [get_ports {OV7670_D[3]}] 
set_property IOSTANDARD LVCMOS33 [get_ports {OV7670_D[3]}]
##Sch name = JB4
set_property PACKAGE_PIN W7 [get_ports {OV7670_D[5]}] 
set_property IOSTANDARD LVCMOS33 [get_ports {OV7670_D[5]}]
##Sch name = JB7
set_property PACKAGE_PIN W9 [get_ports OV7670_PWDN]
set_property IOSTANDARD LVCMOS33 [get_ports OV7670_PWDN]
##Sch name = JB8
set_property PACKAGE_PIN Y9 [get_ports {OV7670_D[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {OV7670_D[0]}]
##Sch name = JB9
set_property PACKAGE_PIN Y8 [get_ports {OV7670_D[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {OV7670_D[2]}]
##Sch name = JB10
set_property PACKAGE_PIN Y7 [get_ports {OV7670_D[4]}]
